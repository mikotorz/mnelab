...
- Add a Pipeline action to chain multiple preprocessing steps (Apply Montage, Mark Bad Channels, Filter, Resample, Crop, Events from Annotations, Run ICA) into a single run ([#700](https://github.com/cbrnr/mnelab/pull/700) by [mikotorz](https://github.com/mikotorz))
...
- Add option to save history to a Python file ([#550](https://github.com/cbrnr/mnelab/pull/550) by [Clemens Brunner](https://github.com/cbrnr))
- Add option to save channel stats to CSV file ([#551](https://github.com/cbrnr/mnelab/pull/551) by [Clemens Brunner](https://github.com/cbrnr))
